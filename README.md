...
My name is Danil Zaks. I'm 19 years old.
...
sk10az:~$ fetchme
           ...
           (                ├─ Uptime ~ 19years
    /\  .-"""-.  /\         ├─ OS ~ Arch Linux
   //\\/  ,,,  \//\\        ├─ Languages ~ Js, Python, Shell
   |/\| ,;;;;;, |/\|        ├─ DE ~ BSPWM/XFCE
   //\\\;-"""-;///\\        ├─ Shell ~ zsh
  //  \/   .   \/  \\       ├─ Terminal ~ Kitty
 (| ,-_| \ | / |_-, |)      ├─ Editor ~ WebStorm, VSCode, Vim
   //`__\.-.-./__`\\        └─ Hobbies ~ reading and boxing
  // /.-(() ())-.\ \\"
 (\ |)   '---'   (| /)      .  contacts
  ` (|           |) `       │
    \)           (/         ├─ Email ~ sk10azik@gmail.com
                            ├─ Instagram ~ sk10az
                            └─ Telegram ~ https://t.me/lok4lz
```
